    ...
    <aside className="fixed left-0 top-0 h-screen w-64 bg-slate-900 flex flex-col z-40">
      ...
      <div className="px-6 py-6 border-b border-slate-800">
        <Link to="/" className="flex items-center gap-3">
          ...
          <div>
            <p className="text-white font-bold text-base leading-none">Academy</p>
      ...
      <div className="px-3 py-4 border-t border-slate-800 space-y-1">
        <div className="flex items-center gap-2 px-3 py-2">
          <div className={`w-2 h-2 rounded-full flex-shrink-0 ${isConnected ? 'bg-emerald-400' : 'bg-red-400'}`} />
          <span className="text-xs text-slate-400">{isConnected ? 'Live updates on' : 'Offline'}</span>
        </div>
        <button
          onClick={logout}
