...
public class LoginRequest {
  ...
  */
  ...
  @Schema(name = "username", example = "admin@academy.com", description = "User email address", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
  @NotNull 
  @Schema(name = "password", example = "password123", description = "User password", requiredMode = Schema.RequiredMode.REQUIRED)
